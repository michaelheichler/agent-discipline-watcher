...
2. Add or update the row in the cross-client event parity matrix in `README.md`. Use the status vocabulary already defined there: wired, degraded, not-available, unknown.
